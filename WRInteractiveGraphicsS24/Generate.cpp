...
std::shared_ptr<VertexBuffer> Generate::CuboidNorm(float width, float height, float depth, glm::vec4 color, glm::vec3 normal, glm::vec2 tex)
{
	...
	float halfDepth = depth / 2;
	// Front face
	buffer->AddVertexData(12, -halfWidth, halfHeight, halfDepth, color.r, color.g, color.b, color.a, 0, 0, normal[2], 0.0f, tex.t);
	buffer->AddVertexData(12, -halfWidth, -halfHeight, halfDepth, color.r, color.g, color.b, color.a, 0, 0, normal[2], 0.0f, 0.0f);
	buffer->AddVertexData(12, halfWidth, -halfHeight, halfDepth, color.r, color.g, color.b, color.a, 0, 0, normal[2], tex.s, 0.0f);
	buffer->AddVertexData(12, -halfWidth, halfHeight, halfDepth, color.r, color.g, color.b, color.a, 0, 0, normal[2], 0.0f, tex.t);
	buffer->AddVertexData(12, halfWidth, -halfHeight, halfDepth, color.r, color.g, color.b, color.a, 0, 0, normal[2], tex.s, 0.0f);
	buffer->AddVertexData(12, halfWidth, halfHeight, halfDepth, color.r, color.g, color.b, color.a, 0, 0, normal[2], tex.s, tex.t);
	// Right face		  
	buffer->AddVertexData(12, halfWidth, halfHeight, halfDepth, color.r, color.g, color.b, color.a, 0, 0, normal[2], 0.0f, tex.t);
	buffer->AddVertexData(12, halfWidth, -halfHeight, halfDepth, color.r, color.g, color.b, color.a, 0, 0, normal[2], 0.0f, 0.0f);
	buffer->AddVertexData(12, halfWidth, -halfHeight, -halfDepth, color.r, color.g, color.b, color.a, 0, 0, normal[2], tex.s, 0.0f);
...
std::shared_ptr<VertexBuffer> Generate::XZPlaneNorm(float width, float depth, glm::vec4 color, glm::vec3 normal, glm::vec2 tex)
{
	...
	float halfWidth = width / 2;
	float halfDepth = depth / 2;
	buffer->AddVertexData(12, -halfWidth, 0, -halfDepth, color.r, color.g, color.b, color.a, 0, 0, normal[2], 0.0f, tex.t);
	buffer->AddVertexData(12, -halfWidth, 0, halfDepth, color.r, color.g, color.b, color.a, 0, 0, normal[2], 0.0f, 0.0f);
	buffer->AddVertexData(12, halfWidth, 0, halfDepth, color.r, color.g, color.b, color.a, 0, 0, normal[2], tex.s, 0.0f);
	buffer->AddVertexData(12, -halfWidth, 0, -halfDepth, color.r, color.g, color.b, color.a, 0, 0, normal[2], 0.0f, tex.t);
	buffer->AddVertexData(12, halfWidth, 0, halfDepth, color.r, color.g, color.b, color.a, 0, 0, normal[2], tex.s, 0.0f);
	buffer->AddVertexData(12, halfWidth, 0, -halfDepth, color.r, color.g, color.b, color.a, 0, 0, normal[2], tex.s, tex.t);
